...
------------
    ...
    ├── data
    │   ├── external       <- Data from third party sources. [hevc, h264]
    |   ├── final          <- Final data to be trained and evaluated on [train, test, valid]
    │   ├── interim        <- Intermediate data that has been transformed. [split2m, labels]
    │   ├── processed      <- The final, canonical data sets for modeling. [imgs, masks]
    │   └── raw            <- The original, immutable data dump. [zipped raw data from source]
    │
